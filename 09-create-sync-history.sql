...
COMMENT ON COLUMN sync_history.total_updated IS 'Number of peta_jabatan records updated';
...
COMMENT ON COLUMN sync_history.synced_at IS 'Timestamp when the sync was performed';
