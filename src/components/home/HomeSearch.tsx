...
import { APIRow, SearchItem, buildItemsFromFlat as libBuildItemsFromFlat } from "@/lib/search";
...
export default function HomeSearch() {
  ...
  // use the shared implementation from src/lib/search
  // keep signature same for local use
  const buildItemsFromFlat = useCallback((rows: APIRow[]) => libBuildItemsFromFlat(rows), []);
