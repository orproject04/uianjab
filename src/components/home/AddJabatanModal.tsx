    ...
    const loadParents = async () => {
      ...
      try {
        ...
        const buildOptions = (rows: APIRow[]): ParentOption[] => {
          ...
          const options: ParentOption[] = [{ id: "", label: "-- Root / Tidak ada parent --", level: 0 }];
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-gray-500">
                URL-friendly identifier (otomatis di-generate dari nama jabatan)
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-gray-500">
                Pilih jabatan parent untuk menempatkan jabatan baru sebagai sub-jabatan
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="md:col-span-2">
                ...
                <p className="mt-1 text-xs text-gray-500">
                  ℹ️ Jenis jabatan akan otomatis disesuaikan berdasarkan parent. Pastikan sesuai untuk menghindari gap visual di peta jabatan.
                </p>
              </div>
            </div>
          </div>
