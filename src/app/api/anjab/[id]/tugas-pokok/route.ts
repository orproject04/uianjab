    ...
    try {
        ...
        const ins = await client.query(
            `INSERT INTO tugas_pokok
             ...
             VALUES ($1, $2, $3, $4, $5, $6, $7, $8, NOW(), NOW()) RETURNING id_tugas, id_jabatan, nomor_tugas, uraian_tugas, hasil_kerja, jumlah_hasil,
...
export async function PUT(req: NextRequest, ctx: { params: Promise<{ id: string }> }) {
    ...
    try {
        ...
        await client.query("BEGIN");
        const old = await client.query(`SELECT id_tugas
                                        FROM tugas_pokok
