// src/app/api/anjab/[id]/bahan-kerja/route.ts
    ...
    try {
        ...
        const ins = await client.query(
            `INSERT INTO bahan_kerja
             ...
             VALUES ($1::uuid, $2, $3, NOW(), NOW()) RETURNING id, jabatan_id, bahan_kerja, penggunaan_dalam_tugas`,
