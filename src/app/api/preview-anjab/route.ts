// app/api/preview-anjab/route.js
import pool from "@/lib/db";
import puppeteer from "puppeteer";

export async function GET() {
    // const id = "penelaah_t_1756008787446";
    // const id = "pengolah_d_1756106876345";
    // const id = "pengolah_d_1756167758920";
    // const id = "penata_kel_1756008859428"; //desktop
    const id = "pengolah_d_1756171006721";
    ...
    try {
        ...
        //             j.created_at AS jabatan_created_at,
        //             j.updated_at AS jabatan_updated_at,
        //
        //             u.id_unit_kerja,
        //             u.jpt_utama,
        //             u.jpt_madya,
        ...
        //                  LEFT JOIN unit_kerja u
        //                            ON j.id_jabatan = u.id_jabatan
        //                  LEFT JOIN kualifikasi_jabatan k
        //                            ON j.id_jabatan = k.id_jabatan
        //                  JOIN hasil_kerja h
        //                            ON j.id_jabatan = h.id_jabatan
        //         WHERE j.id_jabatan = $1
        //     `,
        //     [id]
        // );
    ...
    <div class="doc">
        ...
        <table style="width: 99%" class="word-table">
          ...
          <tbody>
            ...
            .map(
                (item, index) => `
                    <tr>
                      ...
                      <td>${renderUraianTugasDanTahapan(item)}</td>
            ...
            .join("")}
              ...
              <tr>
                <td colspan="6" style="text-align: center">JUMLAH PEGAWAI</td>
                <td></td>
              </tr>
          </tbody>
        </table>
      ...
      <div class="section portrait">
        <table class="key-value">
          ...
          <tr>
            <td class="custom-padding kv-left" style="padding-left: 25px; width: 36%;">a. Keterampilan Kerja</td>
            <td class="custom-padding kv-sep">:</td>
          ...
          <tr>
            ...
            <td class="custom-padding kv-sep">:</td>
            <td class="custom-padding kv-right custom-justify">${renderList(data.syarat_jabatan.bakat_kerja)}</td>
          </tr>
          <tr>
            <td class="custom-padding kv-left" style="padding-left: 25px;">c. Temperamen Kerja</td>
            <td class="custom-padding kv-sep">:</td>
            <td class="custom-padding kv-right custom-justify">${renderList(data.syarat_jabatan.temperamen_kerja)}</td>
          </tr>
          <tr>
            <td class="custom-padding kv-left" style="padding-left: 25px;">d. Minat Kerja</td>
            <td class="custom-padding kv-sep">:</td>
            <td class="custom-padding kv-right custom-justify">${renderList(data.syarat_jabatan.minat_kerja)}</td>
          </tr>
          <tr>
          ...
          <tr>
            <td class="custom-padding kv-left" style="padding-left: 25px;"><span style="padding-right: 5px">f.</span> Kondisi Fisik</td>
            <td class="custom-padding kv-sep">:</td>
            <td class="custom-padding kv-right custom-justify"></td>
          </tr>
          <tr>
            ...
            <td class="custom-padding kv-sep">:</td>
            <td class="custom-padding kv-right custom-justify">${data.syarat_jabatan.kondisi_fisik_jenkel}</td>
          </tr>
          <tr>
            <td class="custom-padding kv-left" style="padding-left: 43px;">2) Umur</td>
            <td class="custom-padding kv-sep">:</td>
            <td class="custom-padding kv-right custom-justify">${data.syarat_jabatan.kondisi_fisik_umur}</td>
          </tr>
          <tr>
            <td class="custom-padding kv-left" style="padding-left: 43px;">3) Tinggi Badan</td>
            <td class="custom-padding kv-sep">:</td>
            <td class="custom-padding kv-right custom-justify">${data.syarat_jabatan.kondisi_fisik_tb}</td>
          </tr>
          <tr>
            <td class="custom-padding kv-left" style="padding-left: 43px;">4) Berat Badan</td>
            <td class="custom-padding kv-sep">:</td>
            <td class="custom-padding kv-right custom-justify">${data.syarat_jabatan.kondisi_fisik_bb}</td>
          </tr>
          <tr>
            <td class="custom-padding kv-left" style="padding-left: 43px;">5) Postur Badan</td>
            <td class="custom-padding kv-sep">:</td>
            <td class="custom-padding kv-right custom-justify">${data.syarat_jabatan.kondisi_fisik_pb}</td>
          </tr>
          <tr>
            <td class="custom-padding kv-left" style="padding-left: 43px;">6) Penampilan</td>
            <td class="custom-padding kv-sep">:</td>
            <td class="custom-padding kv-right custom-justify">${data.syarat_jabatan.kondisi_fisik_tampilan}</td>
          </tr>
          <tr>
            <td class="custom-padding kv-left" style="padding-left: 43px;">7) Keadaan Fisik</td>
            <td class="custom-padding kv-sep">:</td>
            <td class="custom-padding kv-right custom-justify">${data.syarat_jabatan.kondisi_fisik_keadaan}</td>
          </tr>
          <tr>
            <td class="custom-padding kv-left" style="padding-left: 25px; width: 36%;">g. Fungsi Pekerja</td>
            <td class="custom-padding kv-sep">:</td>
            <td class="custom-padding kv-right custom-justify">${renderList(data.syarat_jabatan.fungsi_pekerja)}</td>
          </tr>
        </table>
      </div>
      ...
      <div class="section portrait">
        <table class="key-value">
          ...
          <tr>
            <td class="custom-padding kv-left" style="padding-left: 30px; width: 36%;">${data.prestasi_diharapkan}</td>
          </tr>
        </table>
      </div>
      ...
      <div class="section portrait">
        <table class="key-value">
          ...
          <tr>
            <td class="custom-padding kv-left" style="padding-left: 30px; width: 36%;">${data.kelas_jabatan}</td>
          </tr>
        </table>
      </div>
  </body>
