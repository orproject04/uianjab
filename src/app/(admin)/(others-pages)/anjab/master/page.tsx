                        ...
                        if (line.startsWith("data: ")) {
                            try {
                                ...
                                if (data.total !== undefined && data.done === undefined) {
                                    ...
                                    if (messageEl) messageEl.innerText = `Menyiapkan ${data.total} file...`;
                                    ...
                                    const messageEl = document.getElementById("swal-progress-message");
                                    if (messageEl) messageEl.innerText = data.message || "Menunggu...";
                                } else if (data.error) {
                            ...
                            {showDownloadMenu && (
                                <>
                                    ...
                                    <div className="origin-top-right absolute right-0 mt-2 w-72 rounded-xl shadow-lg bg-white dark:bg-gray-800 ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 dark:divide-gray-700 z-20">
                                        <div className="py-1">
                                            <button
                                                onClick={() => { setShowDownloadMenu(false); handleBulkDownload("groups", "Per Biro (Word)", "word"); }}
                                            ...
                                            <button
                                                onClick={() => { setShowDownloadMenu(false); handleBulkDownload("groups", "Per Biro (PDF)", "pdf"); }}
                                                className="group flex w-full items-center gap-3 px-4 py-3 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors"
                                            >
                                                <div className="p-2 bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 rounded-lg group-hover:bg-red-100 dark:group-hover:bg-red-900/40">
                                                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                        ...
                        <div className="flex items-center gap-2 sm:gap-3">
                            ...
                            <button
                                ...
                                className="flex-1 sm:flex-initial inline-flex items-center justify-center gap-2 px-4 py-2 text-sm bg-blue-light-500 text-white rounded-lg hover:bg-blue-light-700 transition-colors whitespace-nowrap"
                            >
                                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                >
                                    ...
                                    <div className="border-t border-gray-200 dark:border-gray-700 p-3 flex gap-2 bg-gradient-to-b from-gray-50/80 to-gray-100/80 dark:from-gray-800/50 dark:to-gray-900/50 backdrop-blur-sm">
                                        ...
                                        <button
                                            ...
                                            className="flex-1 inline-flex items-center justify-center gap-2 px-3 py-2 text-xs font-medium text-white bg-gradient-to-r from-brand-600 to-brand-500 dark:from-brand-500 dark:to-brand-600 rounded-lg hover:from-brand-700 hover:to-brand-600 dark:hover:from-brand-600 dark:hover:to-brand-700 shadow-sm hover:shadow transition-all"
                                            title="Edit Anjab"
                                        >
                                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
