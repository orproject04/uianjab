...
export default function InformasiJabatanPage() {
    ...
    const handleDownloadDocx = async () => {
        ...
        try {
            ...
            // Use the new docx-template API directly
                            ...
                            {pdfSrc && (
                                <div className="flex items-center gap-2 flex-shrink-0">
                                    <a
                                        ...
                                        className="inline-flex items-center gap-1.5 px-2.5 py-1.5 text-xs sm:text-sm outline-1 outline-green-700 bg-white text-black rounded hover:bg-green-200 transition-colors"
                                    >
                                        <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
