    ...
    return (
        <div className="flex flex-col gap-3 p-4">
            <div className="flex flex-wrap items-center gap-2">
                ...
                <button className="px-3 py-1.5 rounded border text-sm hover:bg-gray-50" onClick={load}
                        disabled={loading}>
                ...
                <div className="ml-auto flex items-center gap-2">
                    ...
                    />
                    <button className="px-2 py-1.5 rounded border text-sm hover:bg-gray-50"
                            onClick={() => setFilter("")}>
                        Reset
                    </button>
            ...
            <div className="text-xs text-gray-500">
                • Drag background untuk pan, scroll untuk zoom. Klik kotak atau panah untuk show/hide anak. Fullscreen
                didukung.
            </div>
        </div>
    );
