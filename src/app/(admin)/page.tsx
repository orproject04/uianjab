    ...
    <div className="w-full min-h-[calc(100dvh-200px)] flex items-start justify-center">
      ...
      <div className="w-full max-w-3xl pt-8 px-4 md:px-6">
        ...
        <div className="mt-8 flex justify-center">
          <button
            onClick={() => router.push("/anjab/create")}
            className="inline-flex items-center gap-2 rounded-xl bg-violet-600 px-4 py-2.5 text-sm font-medium text-white shadow-sm hover:bg-violet-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-violet-600"
          >
