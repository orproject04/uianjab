...
export default function HelpPage() {
    ...
    const mainContentMargin = isMobileOpen ? "ml-0" : isExpanded || isHovered ? "lg:ml-[350px]" : "lg:ml-[90px]";

    useEffect(() => {
        // Simple tab logic: add click handlers to buttons with data-tab
        ...
        function activate(tab: string) {
            buttons.forEach((b) => {
                ...
                b.classList.toggle("border-purple-600", isActive);
                b.classList.toggle("text-purple-600", isActive);
        ...
        function onClick(e: Event) {
            ...
            const t = btn.getAttribute("data-tab") || "akun";
            activate(t);
        }

        buttons.forEach((b) => b.addEventListener("click", onClick));
        activate("akun"); // default tab
    ...
    return (
        <div className="min-h-screen xl:flex">
            <AppSidebar />
            <div className={`flex-1 min-h-screen ${mainContentMargin}`}>
                <AppHeader />
                    ...
                    <div className="mx-auto max-w-5xl bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 overflow-hidden shadow-lg">
                        ...
                        <div className="border-b border-gray-200 dark:border-gray-800">
                            <div className="flex items-center gap-1 px-6">
                                <button 
                                    data-tab="akun" 
                                    className="tab-btn py-4 px-6 text-sm font-medium border-b-2 border-transparent hover:text-purple-600 hover:border-purple-300 flex items-center gap-2" 
                                    aria-current="true"
                                >
                                ...
                                <button 
                                    data-tab="peta" 
                                    className="tab-btn py-4 px-6 text-sm font-medium text-gray-600 border-b-2 border-transparent hover:text-purple-600 hover:border-purple-300 flex items-center gap-2"
                                >
                                    <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none">
                        ...
                        <div id="tab-content">
                            ...
                            <section data-panel="akun" className="p-6">
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                    ...
                                    <div className="rounded-lg border border-gray-200 dark:border-gray-800 overflow-hidden bg-white dark:bg-gray-900">
                                        <div className="aspect-video bg-gray-100 dark:bg-gray-800 flex items-center justify-center">
                                            ...
                                            <img src="/images/help/signup-form.png" alt="Contoh tampilan Sign Up" className="object-contain w-full h-full" />
                                        </div>
                                        <div className="p-4">
                                            ...
                                            <ol className="list-decimal list-inside space-y-2 text-sm text-gray-700 dark:text-gray-200 ml-8">
                                    ...
                                    <div className="rounded-lg border border-gray-200 dark:border-gray-800 overflow-hidden bg-white dark:bg-gray-900">
                                        <div className="aspect-video bg-gray-100 dark:bg-gray-800 flex items-center justify-center">
                                            ...
                                            <img src="/images/help/signin-form.png" alt="Contoh tampilan Sign In" className="object-contain w-full h-full" />
                                        </div>
                                        <div className="p-4">
                                            <h3 className="font-semibold text-purple-700 dark:text-purple-400 mb-2 flex items-center gap-2">
                                ...
                                <div className="mt-6 rounded-lg border border-gray-200 dark:border-gray-800 overflow-hidden bg-white dark:bg-gray-900">
                                    <div className="aspect-video bg-gray-100 dark:bg-gray-800 flex items-center justify-center">
                                        {/* Ganti src sesuai contoh email verifikasi */}
                                        <img src="/images/help/email-verification.png" alt="Contoh email verifikasi" className="object-contain w-full h-full" />
                                    </div>
                                    <div className="p-4">
                                        <h3 className="font-semibold text-purple-700 dark:text-purple-400 mb-2 flex items-center gap-2">
                                        ...
                                        <ul className="list-disc list-inside space-y-2 text-sm text-gray-700 dark:text-gray-200 ml-8">
                            ...
                            {/* Tab: Peta Jabatan */}
                            <section data-panel="peta" className="p-6">
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <section data-panel="analisis" className="p-6">
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                    <div className="p-4 rounded-lg bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800">
                                        <h3 className="font-medium mb-2 flex items-center gap-2">
                                            <svg className="w-5 h-5 text-purple-600" viewBox="0 0 24 24" fill="none">
