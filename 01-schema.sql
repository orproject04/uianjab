/* ============================================================================
   ...
   File: 01-schema.sql
   Purpose: Database schema initialization (tanpa data)
   Version: 1.0
   Date: 2025-11-14
   ============================================================================ */
...
CREATE EXTENSION IF NOT EXISTS pg_trgm;    -- untuk fuzzy text matching

-- ============================================================================
-- HELPER FUNCTIONS
-- ============================================================================

-- Update timestamp pada tabel yang diubah
...
-- Sentuh parent jabatan.updated_at saat child berubah
...
-- Sentuh parent jabatan dari tahapan
...
-- ============================================================================
-- MASTER JABATAN (Analisis Jabatan)
-- ============================================================================
...
-- ============================================================================
-- PETA JABATAN (Organizational Structure)
-- ============================================================================
...
CREATE TABLE IF NOT EXISTS peta_jabatan (
  ...
  bezetting         int  NOT NULL DEFAULT 0,
...
CREATE INDEX IF NOT EXISTS idx_jabatan_nama                 ON jabatan USING gin (to_tsvector('indonesian', nama_jabatan));
...
CREATE INDEX IF NOT EXISTS idx_so_nama        ON peta_jabatan USING gin (to_tsvector('indonesian', nama_jabatan));
